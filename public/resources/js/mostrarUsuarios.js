    ...
    $.ajax({
        ...
        success:function(respuesta){
            ...
            $.each(respuesta.usuarios, function(key, item){
                html += "<tr><th scope='row'>"+item.curp+"</th><td>"+item.nombre+"</td><td>"+item.apellidoP+"</td><td>"+item.apellidoM+"</td><td><center><a class='btn btn-primary' href='#' role='button'>Editar</a></center></td></tr>";
            });
