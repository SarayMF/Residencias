...
$routes->get('/Mis activos/agregarAccesorio', 'Asignacion::asignacionAccesorioUsuario');
$routes->post('/Mis activos/guardarAccesorio','Asignacion::createAccesorio');
...
$routes->post('/buscarPuesto', 'Registrar::obtenerPuestos');
$routes->get('/Reporte de activos/generar reporte accesorios', 'Reportes::generarReporteAccesorios');
/*
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
